...
/* Get list of Files on Blob Storage and loop around to load the files into Staging */
 ...
 DECLARE @ExecuteSQL2 NVARCHAR(MAX)
    ...
    SELECT tpr.[RecordType1]
		  ...
		  ,tpr.[RecordType2]
		  ,tpr.[AddressId]
		  ,tpr.[AddressDistrictNumber]
		  ,tpr.[AddressReference]
		  ,tpr.[AddressCode]
		  ,tpr.[AddressFromDate]
		  ,tpr.[AddressToDate]
		  ,tpr.[Name1]
		  ...
		  ,tpr.[EmployerSchemeDistrictNumber]
		  ,tpr.[EmployerSchemeReference]
		  ,tpr.[EmployerSchemeHistStartYear]
		  ,tpr.[EmployerSchemeHistEndYear]
		  ,tpr.[SchemeType]
		  ,tpr.[RecordType12]
		  ,tpr.[EmployerCountDistrictNumber]
          ,tpr.[EmployerCountReference]
		  ,tpr.[EmployerCountID]
		  ,tpr.[EEC_Code]
		  ,tpr.[DateTaken]
		  ,tpr.[NumberCounted]
